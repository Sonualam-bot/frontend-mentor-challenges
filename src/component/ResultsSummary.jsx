...
function ResultsSummary() {
  return (
    <div className="flex min-h-screen justify-center items-center">
      <div className="flex flex-col sm:flex-row   md:w-[650px]   md:h-[450px] sm:h-full justify-center items-center md:pr-7 rounded-3xl text-[18px] md:gap-9  md:shadow-lg font-sans  sm:shadow-none ">
        {/* left part starts here */}
        <div className=" flex flex-col  justify-around w-full sm:w-full   h-[450px]  rounded-2xl p-6 items-center bg-gradient-to-b from-[--light-slate-blue] to-[--light-royal-blue] text-white">
          <div>
        ...
        <div className=" w-full sm:w-full h-[450px] flex flex-col gap-7 py-11 ">
          <div>
